...
DDD::PinholeCamera::PinholeCamera(std::string serialized) :ACamera(point(0, 0, 0), 0) {
...
std::string DDD::PinholeCamera::serialize() const {
	return ACamera::includeClassID(this->background.serialize() + "[" + __super::serialize(), CLASSID);
}
